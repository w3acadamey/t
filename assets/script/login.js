    // Retrieve the number of attempts from sessionStorage
    ...
    function handleSubmit(event) {
        ...
        .then(data => {
            ...
            for (var key in data) {
                if (data.hasOwnProperty(key)) {
                    ...
                    if (userData['Password'] === password) {
                        ...
                        sessionStorage.setItem('loginAttempts', 0); // Reset login attempts to 0
            ...
            // Invalid password
            attempts++;
            sessionStorage.setItem('loginAttempts', attempts); // Store the updated attempts count in sessionStorage
            if (attempts <= 2) {
